...
export function PropertyCard({ property }: PropertyCardProps) {
  ...
  const displayImage = property.images?.[0] || 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=800&q=80';

  return (
    <Link href={`/properties/${property.id}`} className="block group">
      <div className="rounded-2xl overflow-hidden border border-[#e4e4e4] dark:border-[#2e3440] bg-white dark:bg-[#232733] transition-all hover:shadow-xl hover:-translate-y-1 flex flex-col h-full">
        {/* Image Container */}
        ...
        <div className="p-5 space-y-4 flex-1 flex flex-col justify-between">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-200 dark:border-slate-700/80">
            ...
            <div className="text-right ml-auto">
              <span className="text-base font-black text-[#CFA190]">${property.price.toLocaleString()}</span>
